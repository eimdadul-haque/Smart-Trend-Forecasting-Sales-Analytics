    ...
    public partial class Initial_Migration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalesDatasets", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnomalyDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DetectedValue = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AnomalyDetections_SalesDatasets_DatasetId",
                        column: x => x.DatasetId,
                        principalTable: "SalesDatasets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ForecastResults_SalesDatasets_DatasetId",
                        column: x => x.DatasetId,
                        principalTable: "SalesDatasets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Recommendations_SalesDatasets_DatasetId",
                        column: x => x.DatasetId,
                        principalTable: "SalesDatasets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalesRecords_SalesDatasets_DatasetId",
                        column: x => x.DatasetId,
                        principalTable: "SalesDatasets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnomalyDetections_DatasetId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ForecastResults_DatasetId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Recommendations_DatasetId",
                table: "Recommendations",
                column: "DatasetId");

            migrationBuilder.CreateIndex(
                name: "IX_SalesRecords_DatasetId",
                table: "SalesRecords",
                column: "DatasetId");
        }
